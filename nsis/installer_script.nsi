...
;General
  ...
  !define APPNAME "AcquisitionTool"
  ...
  OutFile "AcquisitionTool_Installer_Windows_${VERSIONMAJOR}_${VERSIONMINOR}_${VERSIONBUILD}.exe"
...
Section "Main Component"
  ...
  File "..\build\AcquisitionTool.exe"
  ...
  FILE "..\libs\Windows\dlls\AdapterConfig_v140.dll"
  FILE "..\libs\Windows\dlls\avcodec-57.dll"
  FILE "..\libs\Windows\dlls\avdevice-57.dll"
  FILE "..\libs\Windows\dlls\avfilter-6.dll"
  FILE "..\libs\Windows\dlls\avformat-57.dll"
  FILE "..\libs\Windows\dlls\avutil-55.dll"
  FILE "..\libs\Windows\dlls\cudart64_110.dll"
  FILE "..\libs\Windows\dlls\GCBase_MD_VC140_v3_0.dll"
  FILE "..\libs\Windows\dlls\GenApi_MD_VC140_v3_0.dll"
  FILE "..\libs\Windows\dlls\libEGL.dll"
  FILE "..\libs\Windows\dlls\libGLESv2.dll"
  FILE "..\libs\Windows\dlls\libiomp5md.dll"
  FILE "..\libs\Windows\dlls\Log_MD_VC140_v3_0.dll"
  FILE "..\libs\Windows\dlls\log4cpp_MD_VC140_v3_0.dll"
  FILE "..\libs\Windows\dlls\MathParser_MD_VC140_v3_0.dll"
  FILE "..\libs\Windows\dlls\modelsplugin.dll"
  FILE "..\libs\Windows\dlls\NodeMapData_MD_VC140_v3_0.dll"
  FILE "..\libs\Windows\dlls\nppc64_11.dll"
  FILE "..\libs\Windows\dlls\nppicc64_11.dll"
  FILE "..\libs\Windows\dlls\nppig64_11.dll"
  FILE "..\libs\Windows\dlls\nvjpeg64_11.dll"
  FILE "..\libs\Windows\dlls\Spinnaker_v140.dll"
  FILE "..\libs\Windows\dlls\swresample-2.dll"
  FILE "..\libs\Windows\dlls\swscale-4.dll"
  FILE "..\libs\Windows\dlls\ucrtbase.dll"
  FILE "..\libs\Windows\dlls\XMLParser_MD_VC140_v3_0.dll"
  FILE "..\libs\Windows\ffmpeg.exe"
  ...
  CreateShortCut "$SMPROGRAMS\AcquisitionTool.lnk" "$INSTDIR\AcquisitionTool.exe" "" "$INSTDIR\hand.ico"
