...
FlirConfigBackend::FlirConfigBackend(QObject *parent)
    : QObject(parent), m_camSystem{System::GetInstance()} {
    updateIDs();
}

FlirConfigBackend::~FlirConfigBackend() { m_camSystem->ReleaseInstance(); }
