...
ConnectionWidget::ConnectionWidget(QWidget *parent)
    ...
    camSavePresetsWindow = new PresetsWindow(&camPresets, "save",
                                             "connectionMode/camPresets", this);
    connect(camLoadPresetsWindow, &PresetsWindow::loadPreset, this,
            &ConnectionWidget::camLoadPresetSlot);
    connect(camSavePresetsWindow, &PresetsWindow::savePreset, this,
            &ConnectionWidget::camSavePresetSlot);
    triggerLoadPresetsWindow = new PresetsWindow(
        &triggerPresets, "load", "connectionMode/triggerPresets", this);
    triggerSavePresetsWindow = new PresetsWindow(
        &triggerPresets, "save", "connectionMode/triggerPresets", this);
    connect(triggerLoadPresetsWindow, &PresetsWindow::loadPreset, this,
            &ConnectionWidget::triggerLoadPresetSlot);
    connect(triggerSavePresetsWindow, &PresetsWindow::savePreset, this,
            &ConnectionWidget::triggerSavePresetSlot);
    ...
    camPanelWidget->setSizePolicy(QSizePolicy::Expanding,
    ...
    createToolBarButton(autoDetectCamerasButton, autoDetectCamerasAction,
                        QIcon::fromTheme("detect_cameras"), true, false,
                        QSize(40, 40));
    ...
    connect(autoDetectCamerasAction, &QAction::triggered, this,
            &ConnectionWidget::autoDetectCamerasClicked);
    ...
    connect(camSavePresetAction, &QAction::triggered, this,
            &ConnectionWidget::camSavePresetsClickedSlot);
    ...
    createToolBarButton(camLoadPresetButton, camLoadPresetAction,
                        ...
                        QSize(40, 40));
    connect(camLoadPresetAction, &QAction::triggered, this,
            &ConnectionWidget::camLoadPresetsClickedSlot);
    ...
    for (auto &camPanel : camPanels) {
        ...
        campanellayout->addWidget(camPanel, idx / (NUM_CAMS / 4),
                                  idx % (NUM_CAMS / 4));
        idx++;
        connect(camPanel, &CamConnectionPanel::camListChanged, this,
                &ConnectionWidget::camListChangedSlot);
        connect(camPanel, &CamConnectionPanel::camAdded, this,
                &ConnectionWidget::camAddedSlot);
        connect(camPanel, &CamConnectionPanel::statusUpdated, this,
                &ConnectionWidget::statusUpdatedSlot);
        connect(this, &ConnectionWidget::camListChanged, camPanel,
                &CamConnectionPanel::otherCamListChanged);
    }
    ...
    triggerSpacer->setSizePolicy(QSizePolicy::Expanding,
                                 QSizePolicy::Expanding);
    ...
    createToolBarButton(triggerSavePresetButton, triggerSavePresetAction,
                        QIcon::fromTheme("upload"), true, false, QSize(40, 40));
    connect(triggerSavePresetAction, &QAction::triggered, this,
            &ConnectionWidget::triggerSavePresetsClickedSlot);
    ...
    createToolBarButton(triggerLoadPresetButton, triggerLoadPresetAction,
                        QIcon::fromTheme("download"), true, false,
                        QSize(40, 40));
    connect(triggerLoadPresetAction, &QAction::triggered, this,
            &ConnectionWidget::triggerLoadPresetsClickedSlot);
    ...
    connect(triggerPanel, &TriggerConnectionPanel::triggerInstanceChanged, this,
            &ConnectionWidget::triggerInstanceChangedSlot);
...
void ConnectionWidget::camListChangedSlot() { emit camListChanged(); }
...
void ConnectionWidget::camLoadPresetSlot(QString preset) {
    ...
    for (auto &camPanel : camPanels) {
        ...
        if (settings->value("isConfigured").toBool()) {
            camPanel->camTypeCombo->setCurrentText(
                settings->value("cameraType").toString());
            QString cameraName = settings->value("cameraName").toString();

            camPanel->camConfigInterface->loadPreset(settings);
            camPanel->camera =
                camPanel->camConfigInterface->getCamera(cameraName);
            connect(camPanel->camera, &CameraInterface::statusUpdated, camPanel,
                    &CamConnectionPanel::statusUpdatedSlot);
...
void ConnectionWidget::autoDetectCamerasClicked() {
    ...
    for (auto &camPanel : camPanels) {
        camPanel = new CamConnectionPanel(this);
        campanellayout->addWidget(camPanel, idx / (NUM_CAMS / 3),
                                  idx % (NUM_CAMS / 3));
        connect(camPanel, &CamConnectionPanel::camListChanged, this,
                &ConnectionWidget::camListChangedSlot);
        connect(camPanel, &CamConnectionPanel::camAdded, this,
