...
class SaveFlirPresetsWindow : public SaveCameraPresetsInterface {
	...
	public:
		explicit SaveFlirPresetsWindow(FLIRChameleon *cam, QWidget *parent = nullptr);
...
class UserSetListWidget : public QListWidget {
	Q_OBJECT
	public:
		explicit UserSetListWidget(QWidget *parent = nullptr) : QListWidget(parent) {
			setContextMenuPolicy(Qt::CustomContextMenu);
			connect(this, &UserSetListWidget::customContextMenuRequested, this, &UserSetListWidget::showContextMenu);
		}
