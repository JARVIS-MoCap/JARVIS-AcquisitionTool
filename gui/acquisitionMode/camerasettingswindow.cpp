...
CameraSettingsWindow::CameraSettingsWindow(QWidget *parent,
    ...
    connect(advancedSimpleAction, &QAction::toggled, this,
            &CameraSettingsWindow::advancedSimpleToggledSlot);
    ...
    connect(expandAction, &QAction::triggered, this,
            &CameraSettingsWindow::expandClickedSlot);
    ...
    connect(savePresetAction, &QAction::triggered, this,
            &CameraSettingsWindow::savePresetsClickedSlot);
    ...
    connect(loadPresetAction, &QAction::triggered, this,
            &CameraSettingsWindow::loadPresetsClickedSlot);
    ...
    connect(searchEdit, &QLineEdit::textEdited, this,
            &CameraSettingsWindow::searchEditedSlot);
    connect(searchEdit, &QLineEdit::returnPressed, this,
            &CameraSettingsWindow::searchReturnPressedSlot);
    ...
    LabelWithToolTip *exposureAutoLabel = new LabelWithToolTip(
        "  Exposure Auto",
    ...
    connect(exposureToggle, &ToggleSwitch::toggled, this,
            &CameraSettingsWindow::exposureAutoToggledSlot);
    LabelWithToolTip *exposureTimeLabel = new LabelWithToolTip(
        "  Exposure Time [ms]",
        "Exposure Time in Milliseconds, keep as low as "
    ...
    LabelWithToolTip *gainAutoLabel = new LabelWithToolTip(
        "  Gain Auto",
    ...
    connect(gainToggle, &ToggleSwitch::toggled, this,
            &CameraSettingsWindow::gainAutoToggledSlot);
    LabelWithToolTip *gainValueLabel = new LabelWithToolTip(
        "  Gain [dB]",
    ...
    LabelWithToolTip *widthLabel = new LabelWithToolTip(
        "  Image Width",
    ...
    connect(widthEdit, QOverload<int>::of(&QSpinBox::valueChanged), this,
            &CameraSettingsWindow::widthEditChangedSlot);
    LabelWithToolTip *heightLabel = new LabelWithToolTip(
        "  Image Height",
    ...
    connect(heightEdit, QOverload<int>::of(&QSpinBox::valueChanged), this,
            &CameraSettingsWindow::heightEditChangedSlot);
    ...
    connect(flipHorizontalToggle, &ToggleSwitch::toggled, this,
            &CameraSettingsWindow::flipHorizontalToggledSlot);
    LabelWithToolTip *flipVerticalLabel = new LabelWithToolTip(
        "  Vertical Flip",
    ...
    connect(flipVerticalToggle, &ToggleSwitch::toggled, this,
            &CameraSettingsWindow::flipVerticalToggledSlot);

    setupAllCamerasButton = new QPushButton("Setup all Cameras");
    connect(setupAllCamerasButton, &QPushButton::clicked, this,
            &CameraSettingsWindow::setupAllCamerasButtonClickedSlot);
...
void CameraSettingsWindow::setSettingsObjectSlot(SettingsObject *newSettings) {
    if (m_activeSettings != nullptr) {
        ...
        if (m_activeSettings->parent() != nullptr) {
            ...
            if (m_cam != nullptr) {
                disconnect(m_cam, &CameraInterface::simpleSettingChanged, this,
                           &CameraSettingsWindow::simpleSettingChangedSlot);
            }
        }
    }
    toolTipBox->setText("");
    if (newSettings == nullptr) {
        ...
        m_cam = static_cast<CameraInterface *>(m_activeSettings->parent());
        connect(m_cam, &CameraInterface::simpleSettingChanged, this,
                &CameraSettingsWindow::simpleSettingChangedSlot);
...
void CameraSettingsWindow::savePresetsClickedSlot() {
    if (m_activeSettings != nullptr) {
        if (m_activeSettings->getRootNode()->name() == "FLIR Chameleon") {
            FLIRChameleon *cam =
                static_cast<FLIRChameleon *>(m_activeSettings->parent());
